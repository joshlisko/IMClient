 ...
 * 
 * This frame takes a buddy specified by the user and attempts
 * to add and create a new chat with said buddy via the 
...
public class NewMessageFrame extends javax.swing.JFrame {
	...
	public NewMessageFrame(String m) {
		super(m);
		initGUI();
	}

	public NewMessageFrame(ConnectionManager m) {
		super("New Message");
		connectionManager = m;
		initGUI();
	}
