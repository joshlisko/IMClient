 ...
 * @author Josh Lisko
 * 
 * This frame takes a buddy specified by the user and attempts to remove it via the 
...
public class RemoveBuddyFrame extends javax.swing.JFrame {
	...
	public RemoveBuddyFrame(String m) {
		super(m);
		initGUI();
	}

	public RemoveBuddyFrame(ConnectionManager m) {
		super("Remove Buddy");
		connectionManager = m;
		initGUI();
	}
				...
				}
				{
					...
					jButtonOK.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							removeBuddy(jTextFieldBuddy.getText());
						}
					});
	...
	private void removeBuddy(String id) {
		try {
			connectionManager.removeBuddy(id);
		} catch (Exception e) {
